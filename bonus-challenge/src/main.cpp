      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
    	  ...
    	  iss_L >> sensor_type_L;
      	  ...
      	  meas_package_L.sensor_type = MeasurementPackage::LASER;
          meas_package_L.raw_measurements = VectorXd(2);
          float px;
      	  float py;
          iss_L >> px;
          iss_L >> py;
          meas_package_L.raw_measurements << px, py;
          iss_L >> timestamp_L;
          meas_package_L.timestamp = timestamp_L;
    	  ...
    	  iss_R >> sensor_type_R;
      	  ...
      	  // read measurements at this timestamp
      	  meas_package_R.sensor_type = MeasurementPackage::RADAR;
          meas_package_R.raw_measurements = VectorXd(3);
          float ro;
      	  float theta;
      	  float ro_dot;
          iss_R >> ro;
          iss_R >> theta;
          iss_R >> ro_dot;
          meas_package_R.raw_measurements << ro,theta, ro_dot;
          iss_R >> timestamp_R;
          meas_package_R.timestamp = timestamp_R;
